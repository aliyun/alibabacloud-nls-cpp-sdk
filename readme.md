...
发音人：xiaoyun。  
合成音频后103278字节，约3.2秒。  
3.3.0a开始为了提升测试准确度，运行5分钟求平均每分钟的结果。  
北京Client请求上海Server.

#### 性能测试数据
|  版本  | 链接模式 | 并发数 | 启用事件池数 | 首包延迟 | 单轮时长 |  CPU占用率   | 每分钟完成请求数 |           备注           |
| :----: | :----: | :---: | :--------: | :-----: | :----: | :----------: | :-----------: | :---------------------: |
...
| 3.2.1a | 短链接  |  100  |     1      |  277ms  |  388ms | 113% / 1600% |     15576     |                         |
| 3.2.1b | 短链接  |  100  |     1      |  271ms  |  374ms | 116% / 1600% |     15898     | Release / LogLevelDebug |
| 3.2.1b | 短链接  |  100  |     1      |  262ms  |  361ms |  85% / 1600% |     16501     | Release / LogLevelInfo  |
| 3.3.0a | 预链接  |  100  |     1      |   73ms  |  300ms | 129% / 1600% |     18167     | Release / LogLevelInfo  |
| 3.1.14 | 短链接  |  100  |     4      |  341ms  |  507ms | 266% / 1600% |     12357     |                         |
| 3.1.16 | 短链接  |  100  |     4      |  570ms  | 1833ms |  78% / 1600% |      3360     |                         |
| 3.2.1b | 短链接  |  100  |     4      |  261ms  |  360ms | 108% / 1600% |     16600     | Release / LogLevelInfo  |
| 3.3.0a | 预链接  |  100  |     4      |   54ms  |   81ms | 311% / 1600% |     68793     | Release / LogLevelInfo  |
| 3.1.14 | 短链接  |  200  |     4      |  530ms  |  924ms | 294% / 1600% |     13921     |                         |
| 3.2.1a | 短链接  |  200  |     4      |  410ms  |  757ms | 130% / 1600% |     10607     |                         |
| 3.3.0a | 预链接  |  200  |     4      |     ms  |     ms |    % / 1600% |               |                         |
...
|  版本  | 链接模式 | 并发数 | 运行时长 | 完成请求数 | 首包延迟 | 首包延迟<=50ms | 首包延迟<=100ms | 首包延迟<=200ms |  首包延迟<=500ms  | 首包延迟<=1000ms | 首包延迟<=1500ms | 首包延迟<=2000ms | 首包延迟>2000ms |           备注           |
| :----: | :----: | :---: | :-----: | :------: | :-----: | :----------: | :------------: | :------------: | :-------------: | :-------------: | :------------: | :-------------: | :------------: | :---------------------: |
| 3.2.1a | 短链接  |   20  |   120h  |   618553 |  316ms  |       0      |       0        |        0       | 616487(996.660‰)|   2045(3.306‰)  |     16(0.026‰) |       4(0.006‰) |     1(0.0002‰) |   Debug / LogLevelInfo  |
| 3.3.0a | 预链接  |   20  |   120h  |   626921 |  116ms  | 1372(2.188‰) |233593(372.604‰)|360763(575.452‰)|  30718(48.998‰) |    471(0.751‰)  |      5(0.008‰) |       0         |     0          |   Debug / LogLevelInfo  |
...
#### 性能测试数据
|  版本  | 链接模式 | 并发数 | 启用事件池数 | Started延迟 | 首包延迟 | 单轮时长 |     CPU占用率   | 每分钟完成请求数 |           备注           |        发音人        |
| :----: | :----: | :---: | :--------: | :--------: |:------: | :-----: | :------------: | :-----------: | :---------------------: | :-----------------: |
| 3.2.1b | 短链接  |   20  |     1      |     93ms   |  367ms  |  3456ms |   5.1% / 1600% |       349     |   Debug / LogLevelInfo  |    longxiaoxia_v2   |
| 3.3.0a | 预链接  |   20  |     1      |     10ms   |  426ms  |  2123ms |   4.5% / 1600% |       568     |   Debug / LogLevelInfo  |    longxiaoxia      |
| 3.3.0a | 预链接  |   20  |     1      |     10ms   |  288ms  |  3373ms |   3.2% / 1600% |       357     |   Debug / LogLevelInfo  |    longxiaoxia_v2   |

#### 首包延迟稳定性测试数据
合成文本为测试用例随机长句(现在开始进行流式语音合成测试2025-02-13 10:47:05 839202。+ 随机长句)  
北京Client请求北京Server.

|  版本  | 链接模式 | 并发数 | 运行时长 | 完成请求数 | 首包延迟 | 首包延迟<=50ms | 首包延迟<=100ms | 首包延迟<=200ms | 首包延迟<=500ms | 首包延迟<=1000ms | 首包延迟<=1500ms | 首包延迟<=2000ms | 首包延迟>2000ms |           备注           |        发音人         |
| :----: | :----: | :---: | :-----: | :------: | :-----: | :----------: | :------------: | :------------: | :------------:| :------------: | :-------------: | :-------------: | :------------: | :---------------------: | :------------------: |
| 3.2.1a | 短链接  |   5   |    12h  |   11800  |   333ms |      0       |        0       |        0       |11744(995.254‰)|     64(5.424‰) |        0        |        0        |        0       |   Debug / LogLevelInfo  |    longxiaoxia_v2    |
...
| 3.2.1a | 短链接  |  200  |      4     |   OPUS  | 5287ms |  5928ms |   272ms  |    1249us     | 992% / 1600% |
