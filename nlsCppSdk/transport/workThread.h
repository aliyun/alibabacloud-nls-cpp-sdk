...
public:
    ...
    static void connectEventCallback(evutil_socket_t socketFd , short event, void *arg);
    ...
    static void iosDnsEvent(ConnectNode *node, const char* ip, int aiFamily);
#else
    static void dnsEventCallback(int errorCode, struct evutil_addrinfo *address, void *arg);
#endif
