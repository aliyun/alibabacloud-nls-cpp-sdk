...
#ifndef ALIBABANLS_COMMON_DASH_TOKEN_H_
#define ALIBABANLS_COMMON_DASH_TOKEN_H_
...
class NLS_SDK_CLIENT_EXPORT DashToken {
 public:
  virtual ~DashToken();
  DashToken();
   ...
   * @param APIKey	Secret字符串
   * @return void
   */
  void setAPIKey(const std::string& apiKey);

  void setExpireInSeconds(unsigned int seconds);
...
#endif  // ALIBABANLS_COMMON_DASH_TOKEN_H_
