...
#ifndef NLS_SDK_FLOWING_SYNTHESIZER_LISTENER_H
#define NLS_SDK_FLOWING_SYNTHESIZER_LISTENER_H
...
class FlowingSynthesizerListener : public INlsRequestListener {
 public:
...
#endif  // NLS_SDK_FLOWING_SYNTHESIZER_LISTENER_H
