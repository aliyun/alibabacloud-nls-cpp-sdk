...
DashFunAsrTranscriberListener::DashFunAsrTranscriberListener(
    DashFunAsrTranscriberCallback* cb)
    : _callback(cb) {}

DashFunAsrTranscriberListener::~DashFunAsrTranscriberListener() {}

void DashFunAsrTranscriberListener::handlerFrame(NlsEvent& str) {
