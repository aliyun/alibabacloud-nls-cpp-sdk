...
DialogAssistantListener::DialogAssistantListener(DialogAssistantCallback* cb) : _callback(cb) {
    ...
    switch(type) {
        ...
        case NlsEvent::DialogResultGenerated:
            if (NULL != _callback->_onDialogResultGenerated) {
                _callback->_onDialogResultGenerated(&str, _callback->_paramap[NlsEvent::DialogResultGenerated]);
            }
            break;
        case NlsEvent::Close:
        ...
        case NlsEvent::WakeWordVerificationCompleted:
            if (NULL != _callback->_onWakeWordVerificationCompleted) {
                _callback->_onWakeWordVerificationCompleted(&str, _callback->_paramap[NlsEvent::WakeWordVerificationCompleted]);
            }
            break;
        default:
